...
class SaasClient {
	 ...
	 */
	public function link_billing_account( string $account_ref, ?string $license_id = null, ?string $license_key = null ): void {

		if ( $this->get_api_key() === '' ) {
			return; // Site not registered; OAuth flow can re-fire after registration.
		}
